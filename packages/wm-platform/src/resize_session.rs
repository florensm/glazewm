...
pub struct ResizeSession {
  ...
  /// `true` once the surrogate's solid fill has been dropped, or was never
  /// applied. Keeps [`drop_fill_when_covered`] to a single SWCA call
  /// instead of one per animation tick.
  ///
